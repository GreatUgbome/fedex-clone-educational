...
const AUTH_API = (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') ? 'http://localhost:5002/api' : 'https://us-central1-fedex-37e89.cloudfunctions.net/api';
...
// Expose all auth functions to global window scope for HTML onclick handlers
...
window.checkVerificationToken = checkVerificationToken;
window.openForgotPasswordModal = openForgotPasswordModal;
window.closeForgotPasswordModal = closeForgotPasswordModal;
window.submitForgotPassword = submitForgotPassword;
window.openResendVerificationModal = openResendVerificationModal;
window.closeResendVerificationModal = closeResendVerificationModal;
window.submitResendVerification = submitResendVerification;
